...
const Footer = () => {
    ...
    return (
        <div id="footer" className="flex flex-col items-center mt-5 z-400 bg-[#111827] pt-16">
            ...
            <div className='grid grid-cols-1 gap-2 md:grid-cols-2 md:gap-8'>
                ...
                <div className='flex flex-col'>
                    ...
                    <textArea onChange={handleMessageChange} value={message} className='bg-[#1F2937] text-[#F3F4F6] border-0 rounded px-2 pt-2 pb-[120px] w-[250px] md:w-[320px] m-2 text-justify flex-wrap' type='text' name="myInput" placeholder='Message' />
