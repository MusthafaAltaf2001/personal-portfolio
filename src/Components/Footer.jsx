...
const Footer = () => {
	...
	const emptyFields = () =>
		toast.warning("Email and message fields cannot be left empty!", {
			position: "top-center",
			autoClose: 5000,
			hideProgressBar: false,
			closeOnClick: true,
	...
	const sendMessage = async () => {
		...
		const expressBackendURL =
			"https://personal-portfolio-backend-s20c.onrender.com/sendMessage";
	...
	return (
		<div
			id="footer"
			className="flex flex-col items-center mt-5 z-400 bg-[#111827] pt-16"
		>
			...
			<div className="grid grid-cols-1 gap-2 md:grid-cols-2 md:gap-8">
				...
				<div className="flex flex-col">
					...
					<button
						onClick={sendMessage}
						className="w-40 h-1/12  rounded-md m-2 bg-[#EAB308] px-2 py-1 text-center items-center"
					>
